...
```{r}
terms = c("reported_gender", "race", "ethnicity", "cancer_group",
          "extent_of_tumor_resection", "cancer_predisposition", "age", "Age at Chemo Start", "Age at Radiation Start")
...
terms = c("age", "reported_gender", "race", "ethnicity",
          "mol_sub_group", "CNS region", "extent_of_tumor_resection", 
...
for (group in groups) {
  ...
  if (group %in% c("ATRT", "Low-grade glioma", "Mixed neuronal-glial tumor", "Ependymoma", "Medulloblastoma", "Other high-grade glioma")) {
    ...
    pvalue_list[[group]] <- data.frame(term = terms[terms != "mol_sub_group"],
                                    pvalue = c(age_p, sex_p, race_p, 
                                               ethnicity_p,
                                               region_p, resection_p,
                                               predisposition_p,
