...
hist_file <- file.path(input_dir, 'histologies_v12.tsv')
...
ancestry <- ancestry %>%
  left_join(hist[hist$experimental_strategy == 'WGS', c('Kids_First_Participant_ID', 'Kids_First_Biospecimen_ID_tumor',
...
initial_methyl_subtype <- ancestry %>%
...
ancestry_unique <- initial_opc_subtype %>%
