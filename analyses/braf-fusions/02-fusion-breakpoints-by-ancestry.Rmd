...
Print breakpoint type by predicted ancestry

```{r}
table(braf_hist$breakpoint_type, braf_hist$predicted_ancestry)
```
...
```{r}
table(braf_hist$breakpoint_exons_common, braf_hist$dkfz_v12_methylation_subclass)
fisher.test(table(braf_hist$breakpoint_type, braf_hist$dkfz_v12_methylation_subclass), simulate.p.value = T)
```
