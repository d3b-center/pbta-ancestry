# R Corbett 2024
#
# Generate somalier principal component Kaplan-Meier survival curves and forest plots for PBTA ancestry cohort
...
hist_df <- data.frame(group = c("ATRT",
...
# Loop through PC variables and histologies/subtypes to plot KM survival curves and hazard ratios
